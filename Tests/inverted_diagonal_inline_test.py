...
class InlinePerColorInvertedDiagonalMinusNOGap(unittest.TestCase):
    # picking cells down-left
    ...
    def test_3_inline_minus(self):
        ...
        for i in range(0, 4):
            test_game.model.on_cell_click(3 + i, 4 - i)
            test_game.model.set_color("Red")
    ...
    def test_4_inline_minus(self):
        ...
        for i in range(0, 5):
            test_game.model.on_cell_click(2 + i, 5 - i)
            test_game.model.set_color("Red")
    ...
    def test_4_inline_minus_hitting_9_row(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
    ...
    def test_4_inline_minus_hitting_0_col(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
...
class InlinePerColorInvertedDiagonalMinusGapped(unittest.TestCase):
    # picking cells down-left
    ...
    def test_2_inline_minus_2_contiguous_gap(self):
        ...
        test_game.model.set_color("Red")
        test_game.model.on_cell_click(6, 2)
        test_game.model.set_color("Red")
        test_game.model.on_cell_click(7, 1)
        test_game.model.set_color("Red")
    ...
    def test_2_inline_minus_2_chess_gap(self):
        ...
        for i in range(0, 5, 2):
            test_game.model.on_cell_click(3 + i, 5 - i)
            test_game.model.set_color("Red")
...
class InlinePerColorInvertedDiagonalPlusNOGap(unittest.TestCase):
    # picking cells up-right
    def test_0_inline(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
    ...
    def test_1_inline_minus(self):
        ...
        for i in range(0, 2):
            test_game.model.on_cell_click(7 - i, 4 + i)
            test_game.model.set_color("Red")
    ...
    def test_4_inline_minus_hitting_0_row(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
    ...
    def test_4_inline_minus_hitting_9_col(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
    ...
    def test_inline_minus_with_corner_as_4(self):
        ...
        for i in range(0, 4):
            test_game.model.on_cell_click(4 - i, 5 + i)
            test_game.model.set_color("Red")
...
class InlinePerColorInvertedDiagonalPlusGapped(unittest.TestCase):
    #picking cells up-right
    def test_1_inline_minus_1_gap(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
        ...
        for i in range(0, 3, 2):
            test_game.model.on_cell_click(6 - i, 4 + i)
            test_game.model.set_color("Red")
...
class OtherColorInlinePerColorDiagonalMinus(unittest.TestCase):
    def test_other_color_inline_in_middle(self):
        ...
        test_game.model.on_cell_click(5, 3)
        test_game.model.set_color("Blue")

        for i in range(0, 5, 2):
            test_game.model.on_cell_click(6 - i, 2 + i)
            test_game.model.set_color("Red")
    ...
    def test_other_color_inline_in_middle_mirrored(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
    ...
    def test_other_color_inline_on_end(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
    ...
    def test_other_color_inline_on_end_mirrored(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
        ...
        test_game.model.on_cell_click(2, 6)
        test_game.model.set_color("Blue")
...
class OtherColorInlinePerColorDiagonalPlus(unittest.TestCase):
    def test_other_color_inline_in_middle(self):
        test_field = tk.Tk()
        test_field.title("Test Field")
        ...
        for i in range(0, 5, 2):
            test_game.model.on_cell_click(2 + i, 6 - i)
            test_game.model.set_color("Red")
    ...
    def test_other_color_inline_on_end(self):
        ...
        for row in range(5, 2, -1):
            test_game.model.on_cell_click(row, 3)
            test_game.model.set_color("Red")
    ...
    def test_other_color_inline_on_end_mirrored(self):
        ...
        test_game.model.on_cell_click(6, 3)
        test_game.model.set_color("Blue")
